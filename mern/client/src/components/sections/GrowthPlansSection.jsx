...
const plans = [
    ...
    },
    {
        ...
        features: ['Entry from ₹900/quarter', 'Quarterly contribution cycle', 'Up to 25% yearly growth', '4 easy payments per year'],
    ...
    },
    {
        ...
        features: ['Starting from ₹1,800/6 months', 'Semi-annual contribution', 'Up to 28% yearly growth', 'Only 2 payments per year'],
